...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($error_fields) {
        header("Location: add.php?error_fields=".implode(",",$error_fields));
        exit;
    }
    ...
    $query = "insert into election_system.candidates set c_name ='" . $cnd_name . "',c_national_id = '" . $cnd_national_id . "',c_electoral_symbol ='" . $cnd_symbol."'" ;
